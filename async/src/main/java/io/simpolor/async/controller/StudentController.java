...
import io.simpolor.async.model.ResultDto;
import io.simpolor.async.model.StudentDto;
import io.simpolor.async.repository.entity.Student;
import io.simpolor.async.service.StudentService;
...
public class StudentController {
	...
	public ResultDto register(@RequestBody StudentDto request) {
		...
		studentPrinter.printWord(student.getName());
		studentPrinter.printText(student.getName());
